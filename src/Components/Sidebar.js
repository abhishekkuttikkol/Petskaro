...
const Sidebar = () => {
    ...
    return (
            ...
            <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        ...
                        {user && <a onClick={()=>App.auth().signOut()} class="w-full cursor-pointer font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" >
                            <span class="text-left">
                                <LockIcon/>
                            </span>
                            <span  class="mx-4 text-sm font-normal">
      ...
      <Dialog as="div" className="fixed z-40 inset-0 overflow-hidden" onClose={setopen}>
            ...
            >
              <div className="relative w-screen max-w-md">
                ...
                <div className="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
                  {user && <div className="px-4 sm:px-6">
                    <Dialog.Title className="text-lg font-medium text-gray-900">Welcome {user.displayName}</Dialog.Title>
                  </div>}
            ...
            <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        ...
                        {user && <a class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" >
                            <span class="text-left">
                                <LockIcon/>
                            </span>
                            <span onClick={()=>App.auth().signOut()} class="mx-4 text-sm font-normal">
                                Log out
                            </span>
                        </a>}
                    </div>
