...
const Sidebar = () => {
    ...
    return (
        ...
        <div class="h-screen hidden  sm:block lg:block my-4 ml-4 shadow-lg relative w-50">
            ...
            <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        ...
                        {user && <a class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="#">
                            <span class="text-left">
                                <LockIcon/>
                            </span>
